"""
Train MPR-Net on IRDST-H.

    python train_IRDST-H.py \
        --train_txt  datasets/IRDST-H/train.txt \
        --val_txt    datasets/IRDST-H/val.txt \
...
from utils.dataloader_for_IRDSTH import dataset_collate, seqDataset
from utils.utils import get_classes, show_config
from utils.utils_fit import fit_one_epoch


def parse_args():
    p = argparse.ArgumentParser(description="Train MPR-Net on IRDST-H")
    # ---------------- data ----------------
    p.add_argument("--train_txt", default="datasets/IRDST-H/train.txt")
    p.add_argument("--val_txt", default="datasets/IRDST-H/val.txt")
    p.add_argument("--images_root", default="datasets/IRDST-H/images",
    ...
    # ---------------- logging ----------------
    p.add_argument("--save_dir", default="logs/IRDST-H")
...
if __name__ == "__main__":
    ...
    # evaluate the saved checkpoints with test_IRDST-H.py instead.
