...
Identical architecture to nets/MPR_IRSTD_UAV.py / nets/MPR_IRDSTH.py; only the coarse textual
...
class TargetTextEncoder(nn.Module):
    def __init__(self, num_classes=1, learnable_tokens=16, embed_dim=512):
        super().__init__()
